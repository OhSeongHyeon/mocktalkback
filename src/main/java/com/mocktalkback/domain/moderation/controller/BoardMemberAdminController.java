...
public class BoardMemberAdminController {
    ...
    @GetMapping("/boards/{boardId:\\d+}/admin/members")
    ...
    @PutMapping("/boards/{boardId:\\d+}/admin/members/{memberId:\\d+}/approve")
    ...
    @PutMapping("/boards/{boardId:\\d+}/admin/members/{memberId:\\d+}/reject")
    ...
    @PutMapping("/boards/{boardId:\\d+}/admin/members/{memberId:\\d+}/role")
    ...
    @PutMapping("/boards/{boardId:\\d+}/admin/members/{memberId:\\d+}/status")
