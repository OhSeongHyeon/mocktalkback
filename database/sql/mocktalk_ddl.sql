...
CREATE TABLE tb_files (
    file_id BIGINT        NOT NULL AUTO_INCREMENT COMMENT '첨부파일번호',
...
CREATE TABLE tb_files (
    ...
    deleted_at         DATETIME      NOT NULL COMMENT '삭제일자',
    PRIMARY KEY (file_id)
) COMMENT '첨부파일';
...
CREATE TABLE tb_forum_manager (
    ...
    user_id        BIGINT      NOT NULL COMMENT '회원번호, ON DELETE CASCADE',
...
) COMMENT '포럼 관리자, Combination UNIQUE INDEX (user_id, forum_id)';
...
) COMMENT '커뮤니티 구독 목록, Combination UNIQUE INDEX (user_id, forum_id)';
...
) COMMENT '댓글 싫어요, Combination UNIQUE INDEX (user_id, reply_id)';
...
) COMMENT '게시글 싫어요, Combination UNIQUE INDEX (user_id, thread_id)';
...
) COMMENT '댓글 좋아요, Combination UNIQUE INDEX (user_id, reply_id)';
...
ALTER TABLE tb_users ADD CONSTRAINT UQ_login_id UNIQUE (login_id);
ALTER TABLE tb_users ADD CONSTRAINT UQ_nick_name UNIQUE (nick_name);
ALTER TABLE tb_users ADD CONSTRAINT UQ_email UNIQUE (email);


CREATE TABLE tb_notification (
    notification_id BIGINT        NOT NULL AUTO_INCREMENT COMMENT '알림번호',
    user_id       BIGINT        NOT NULL COMMENT '회원번호 - 알림 수신자, ON DELETE CASCADE',
    sender_id       BIGINT        NULL     COMMENT '발신자 user_id, ON DELETE CASCADE',
...
CREATE TABLE tb_reply (
    ...
    user_id    BIGINT       NOT NULL COMMENT '댓글 작성자, ON DELETE CASCADE',
...
CREATE TABLE tb_role (
    ...
    role_name    VARCHAR(16) NOT NULL COMMENT '권한명',
    auth_bit     INT         NOT NULL DEFAULT 0 COMMENT '권한 구분, 소유권한 확인용 2진 비트',
    created_at   DATETIME    NOT NULL COMMENT '생성일자',
    updated_at   DATETIME    NULL COMMENT '수정일자',
    deleted_at   DATETIME    NULL COMMENT '삭제일자',
    PRIMARY KEY (role_id)
) COMMENT '권한 또는 역할 - admin, moderator, forum_admin, forum_moderator, etc...';
...
) COMMENT '게시글 북마크, Combination UNIQUE INDEX (user_id, thread_id)';
...
-- FK CONSTRAINT =================================================
ALTER TABLE tb_thread ADD CONSTRAINT FK_tb_users_TO_tb_thread
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;

ALTER TABLE tb_reply ADD CONSTRAINT FK_tb_users_TO_tb_reply
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;
...
ALTER TABLE tb_forum_manager ADD CONSTRAINT FK_tb_users_TO_tb_forum_manager
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;

ALTER TABLE tb_users ADD CONSTRAINT FK_tb_role_TO_tb_users
...
ALTER TABLE tb_like_thread ADD CONSTRAINT FK_tb_users_TO_tb_like_thread
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;
...
ALTER TABLE tb_hate_thread ADD CONSTRAINT FK_tb_users_TO_tb_hate_thread
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;
...
ALTER TABLE tb_forum_subscribe ADD CONSTRAINT FK_tb_users_TO_tb_forum_subscribe
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;

ALTER TABLE tb_forum_subscribe ADD CONSTRAINT FK_tb_forum_TO_tb_forum_subscribe
FOREIGN KEY (forum_id) REFERENCES tb_forum (forum_id) ON DELETE CASCADE;

ALTER TABLE tb_thread_bookmark ADD CONSTRAINT FK_tb_users_TO_tb_thread_bookmark
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;

ALTER TABLE tb_thread_bookmark ADD CONSTRAINT FK_tb_thread_TO_tb_thread_bookmark
FOREIGN KEY (thread_id) REFERENCES tb_thread (thread_id) ON DELETE CASCADE;

ALTER TABLE tb_users ADD CONSTRAINT FK_tb_profile_image_TO_tb_users
...
ALTER TABLE tb_notification ADD CONSTRAINT FK_tb_users_TO_tb_notification
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;

ALTER TABLE tb_notification ADD CONSTRAINT FK_tb_users_TO_tb_notification1
...
ALTER TABLE tb_like_reply ADD CONSTRAINT FK_tb_users_TO_tb_like_reply
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;

ALTER TABLE tb_hate_reply ADD CONSTRAINT FK_tb_users_TO_tb_hate_reply
FOREIGN KEY (user_id) REFERENCES tb_users (user_id) ON DELETE CASCADE;
...
CREATE UNIQUE INDEX UQ_tb_forum_manager_user_id_forum_id
ON tb_forum_manager (user_id ASC, forum_id ASC);

CREATE UNIQUE INDEX UQ_tb_forum_subscribe_user_id_forum_id
ON tb_forum_subscribe (user_id ASC, forum_id ASC);

CREATE UNIQUE INDEX UQ_tb_thread_bookmark_user_id_thread_id
ON tb_thread_bookmark (user_id ASC, thread_id ASC);

CREATE UNIQUE INDEX UQ_tb_hate_thread_user_id_thread_id
ON tb_hate_thread (user_id ASC, thread_id ASC);

CREATE UNIQUE INDEX UQ_tb_like_thread_user_id_thread_id
ON tb_like_thread (user_id ASC, thread_id ASC);

CREATE UNIQUE INDEX UQ_tb_like_reply_user_id_reply_id
ON tb_like_reply (user_id ASC, reply_id ASC);

CREATE UNIQUE INDEX UQ_tb_hate_reply_user_id_reply_id
ON tb_hate_reply (user_id ASC, reply_id ASC);
