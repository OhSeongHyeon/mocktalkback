...
ALTER TABLE tb_attachment_file
  ADD CONSTRAINT UQ_file_uuid UNIQUE (file_uuid);
...
ALTER TABLE tb_forum
  ADD CONSTRAINT UQ_forum_name UNIQUE (forum_name);

ALTER TABLE tb_forum
  ADD CONSTRAINT UQ_forum_code UNIQUE (forum_code);
...
(
  ...
  login_id_email   VARCHAR(128) NOT NULL COMMENT '회원 아이디 (이메일)',
...
ALTER TABLE tb_member
  ADD CONSTRAINT UQ_login_id_email UNIQUE (login_id_email);

ALTER TABLE tb_member
  ADD CONSTRAINT UQ_nick_name UNIQUE (nick_name);
...
(
  ...
  noti_type       VARCHAR(20)   NOT NULL COMMENT '알림유형, CHECK (like, mention, board, reply, notice)',
...
ALTER TABLE tb_role
  ADD CONSTRAINT UQ_auth_lv UNIQUE (auth_lv);

CREATE TABLE tb_social_account
(
  social_account_id BIGINT      NOT NULL AUTO_INCREMENT COMMENT '소셜로그인제공자번호',
  member_id         BIGINT      NOT NULL COMMENT '회원번호',
  providder         VARCHAR(30) NULL     COMMENT '제공자',
...
ALTER TABLE tb_thread
  ADD CONSTRAINT FK_tb_member_TO_tb_thread
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_reply
  ADD CONSTRAINT FK_tb_member_TO_tb_reply
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_reply
  ADD CONSTRAINT FK_tb_thread_TO_tb_reply
    FOREIGN KEY (thread_id)
    REFERENCES tb_thread (thread_id);

ALTER TABLE tb_forum_manager
  ADD CONSTRAINT FK_tb_member_TO_tb_forum_manager
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_member
  ADD CONSTRAINT FK_tb_role_TO_tb_member
    FOREIGN KEY (role_id)
    REFERENCES tb_role (role_id);

ALTER TABLE tb_thread
  ADD CONSTRAINT FK_tb_role_TO_tb_thread
    FOREIGN KEY (role_id)
    REFERENCES tb_role (role_id);

ALTER TABLE tb_like_thread
  ADD CONSTRAINT FK_tb_member_TO_tb_like_thread
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_like_thread
  ADD CONSTRAINT FK_tb_thread_TO_tb_like_thread
    FOREIGN KEY (thread_id)
    REFERENCES tb_thread (thread_id);

ALTER TABLE tb_attachment_file
  ADD CONSTRAINT FK_tb_thread_TO_tb_attachment_file
    FOREIGN KEY (thread_id)
    REFERENCES tb_thread (thread_id);

ALTER TABLE tb_hate_thread
  ADD CONSTRAINT FK_tb_member_TO_tb_hate_thread
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_hate_thread
  ADD CONSTRAINT FK_tb_thread_TO_tb_hate_thread
    FOREIGN KEY (thread_id)
    REFERENCES tb_thread (thread_id);

ALTER TABLE tb_thread
  ADD CONSTRAINT FK_tb_forum_TO_tb_thread
    FOREIGN KEY (forum_id)
    REFERENCES tb_forum (forum_id);

ALTER TABLE tb_forum_manager
  ADD CONSTRAINT FK_tb_forum_TO_tb_forum_manager
    FOREIGN KEY (forum_id)
    REFERENCES tb_forum (forum_id);

ALTER TABLE tb_forum_subscribe
  ADD CONSTRAINT FK_tb_member_TO_tb_forum_subscribe
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_forum_subscribe
  ADD CONSTRAINT FK_tb_forum_TO_tb_forum_subscribe
    FOREIGN KEY (forum_id)
    REFERENCES tb_forum (forum_id);

ALTER TABLE tb_thread_bookmark
  ADD CONSTRAINT FK_tb_member_TO_tb_thread_bookmark
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_thread_bookmark
  ADD CONSTRAINT FK_tb_thread_TO_tb_thread_bookmark
    FOREIGN KEY (thread_id)
    REFERENCES tb_thread (thread_id);

ALTER TABLE tb_member
  ADD CONSTRAINT FK_tb_profile_image_TO_tb_member
    FOREIGN KEY (profile_image_id)
    REFERENCES tb_profile_image (profile_image_id);

ALTER TABLE tb_reply
  ADD CONSTRAINT FK_tb_reply_TO_tb_reply
    FOREIGN KEY (parent_id)
    REFERENCES tb_reply (reply_id);

ALTER TABLE tb_notification
  ADD CONSTRAINT FK_tb_member_TO_tb_notification
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_notification
  ADD CONSTRAINT FK_tb_member_TO_tb_notification1
    FOREIGN KEY (sender_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_like_reply
  ADD CONSTRAINT FK_tb_reply_TO_tb_like_reply
    FOREIGN KEY (reply_id)
    REFERENCES tb_reply (reply_id);

ALTER TABLE tb_hate_reply
  ADD CONSTRAINT FK_tb_reply_TO_tb_hate_reply
    FOREIGN KEY (reply_id)
    REFERENCES tb_reply (reply_id);

ALTER TABLE tb_like_reply
  ADD CONSTRAINT FK_tb_member_TO_tb_like_reply
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_hate_reply
  ADD CONSTRAINT FK_tb_member_TO_tb_hate_reply
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);

ALTER TABLE tb_thread_category
  ADD CONSTRAINT FK_tb_forum_TO_tb_thread_category
    FOREIGN KEY (forum_id)
    REFERENCES tb_forum (forum_id);

ALTER TABLE tb_thread
  ADD CONSTRAINT FK_tb_thread_category_TO_tb_thread
    FOREIGN KEY (thread_category_id)
    REFERENCES tb_thread_category (thread_category_id);

ALTER TABLE tb_social_account
  ADD CONSTRAINT FK_tb_member_TO_tb_social_account
    FOREIGN KEY (member_id)
    REFERENCES tb_member (member_id);
